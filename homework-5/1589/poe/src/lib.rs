...
//!
//! Run `cargo doc --package pallet-poe --open` to view this pallet's documentation.
...
pub mod pallet {
    ...
    pub enum Error<T> {
        ...
        ProofNotFound,
        /// The proof is not owned by the caller.
        ProofNotOwner,
    }
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn transfer_claim(
            ...
            let owner = ensure_signed(origin)?;
                ...
                Proofs::<T>::get(&claim).unwrap().0 == owner,
                Error::<T>::ProofNotOwner
            );
            ...
            // Emit an event.
            Self::deposit_event(Event::ClaimTransferred { owner, claim, to });
